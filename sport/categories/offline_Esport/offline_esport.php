...
$query = "SELECT * FROM offline_esports";
        ...
        <div class="col">
            <div class="bg-secondary text-white middle-image-container d-flex justify-content-center align-items-center">
                <div class="middle-image">
                    <span class="middle-image-text">Offline Esport</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($isLoggedIn): ?>
                            <a href="review.php?id=<?= $game['id'] ?>" class="btn btn-primary w-100">
                                View Reviews
                            </a>
                        <?php else: ?>
                            <div>
                                <a href="../../home-page/log-in/log-in.php" class="btn btn-secondary w-100">
